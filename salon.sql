...
INSERT INTO public.services VALUES (1, 'Foot Massage');
INSERT INTO public.services VALUES (2, 'Mud Bath');
INSERT INTO public.services VALUES (3, 'Manicure');
...
--
-- Name: appointments foriegn; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT foriegn FOREIGN KEY (customer_id) REFERENCES public.customers(customer_id);


--
-- Name: appointments foriegnkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT foriegnkey FOREIGN KEY (service_id) REFERENCES public.services(service_id);
